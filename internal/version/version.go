...
// for vaterstakepool and other utilities provided in the same repository.
package version
...
var (
	...
	// build process with:
	// '-ldflags "-X github.com/vatercoin/vaterstakepool/internal/version.PreRelease=foo"'
	...
	// build process with:
	// '-ldflags "-X github.com/vatercoin/vaterstakepool/internal/version.BuildMetadata=foo"'
